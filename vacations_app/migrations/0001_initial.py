# -*- coding: utf-8 -*-
# Generated by Django 1.11.24 on 2019-11-05 14:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', vacations_app.models.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Vacation',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('from_date', models.DateField(validators=[vacations_app.models.validate_weekday])),
